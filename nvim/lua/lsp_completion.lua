...
--
-- vimp.inoremap({"silent", "expr"}, "<Tab>", tab_complete)
--vimp.snoremap({"silent", "expr"}, "<Tab>", tab_complete)
-- vimp.inoremap({"silent", "expr"}, "<S-Tab>", s_tab_complete)
--vimp.snoremap({"silent", "expr"}, "<S-Tab>", s_tab_complete)

-- vimp.inoremap({"silent", "expr"}, "<C-Space>", [[compe#complete()<CR>]])
-- --vimp.inoremap({"silent", "expr"}, "<CR>", [[:call compe#confirm('<CR>')<cr>]])
